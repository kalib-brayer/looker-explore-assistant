...
The following documentation outlines the parameters that can be used to generate the expanded Explore URL.

A general url with key parameters and sample values:

https://company.looker.com/explore/model/explore_name
?fields=view.field_1,view.field_2,view.count
